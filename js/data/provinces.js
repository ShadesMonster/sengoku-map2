...
const PROVINCES = [
    ...
    { id: "yamashiro", name: "Yamashiro", japaneseName: "山城", pathIds: ["path23012"], center: { x: 312.6, y: 540.6 }, terrain: "castle", neighbors: ["yamato", "settsu", "kawachi", "omi", "tanba", "iga"] },
    ...
    { id: "settsu", name: "Settsu", japaneseName: "摂津", pathIds: ["path15012"], center: { x: 293.0, y: 551.8 }, terrain: "castle", neighbors: ["yamashiro", "kawachi", "izumi", "harima", "tanba", "awaji"] },
    ...
    { id: "omi", name: "Omi", japaneseName: "近江", pathIds: ["path21305"], center: { x: 327.2, y: 528.9 }, terrain: "castle", neighbors: ["yamashiro", "iga", "ise", "mino", "echizen", "wakasa", "tanba"] },
    ...
    { id: "echizen", name: "Echizen", japaneseName: "越前", pathIds: ["path31814"], center: { x: 339.8, y: 494.9 }, terrain: "castle", neighbors: ["omi", "mino", "hida", "kaga", "wakasa"] },
    ...
    { id: "izumo", name: "Izumo", japaneseName: "出雲", pathIds: ["path8793"], center: { x: 193.3, y: 523.5 }, terrain: "castle", neighbors: ["hoki", "iwami", "bingo", "oki"] },
    ...
    { id: "aki", name: "Aki", japaneseName: "安芸", pathIds: ["path2577"], center: { x: 173.8, y: 561.7 }, terrain: "castle", neighbors: ["bingo", "iwami", "suo"] },
    ...
    { id: "chikuzen", name: "Chikuzen", japaneseName: "筑前", pathIds: ["path3402"], center: { x: 85.5, y: 603.0 }, terrain: "castle", neighbors: ["buzen", "chikugo", "hizen"] },
